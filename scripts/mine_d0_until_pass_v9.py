...
Every attempt is appended to WQ_D0_V9_RESULTS.json so progress
...
from mining_pipeline.d0_seeds_v9 import SEED_EXPRESSIONS  # noqa: E402

RESULTS_FILE = REPO / "WQ_D0_V9_RESULTS.json"
